...
# Parameters
start_time_of_recording = "04:44:53.000000"
...
# Create filters
sos_bandpass = scipy.signal.iirfilter(4, Wn=[0.5, 100], fs=sample_rate, btype="bandpass", ftype="butter", output="sos")
...
def apply_notch_filter(data, freq, sample_rate, quality_factor=2):
